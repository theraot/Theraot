...
namespace System.Linq.Expressions
{
    public partial class Expression
    {
        ...
        /// <returns>A <see cref="UnaryExpression"/> that has the <see cref="NodeType"/> property equal to <see cref="ExpressionType.Convert"/> and the <see cref="UnaryExpression.Operand"/> and <see cref="Type"/> properties set to the specified values.</returns>
        ...
        /// <returns>A <see cref="UnaryExpression"/> that has the <see cref="NodeType"/> property equal to <see cref="ExpressionType.Convert"/> and the <see cref="UnaryExpression.Operand"/>, <see cref="Type"/>, and <see cref="UnaryExpression.Method"/> properties set to the specified values.</returns>
        /// <param name="expression">An <see cref="Expression"/> to set the <see cref="UnaryExpression.Operand"/> property equal to.</param>
        /// <param name="type">A <see cref="System.Type"/> to set the <see cref="Type"/> property equal to.</param>
        ...
        /// <returns>A <see cref="UnaryExpression"/> that has the <see cref="NodeType"/> property equal to <see cref="ExpressionType.ConvertChecked"/> and the <see cref="UnaryExpression.Operand"/> and <see cref="Type"/> properties set to the specified values.</returns>
        /// <param name="expression">An <see cref="Expression"/> to set the <see cref="UnaryExpression.Operand"/> property equal to.</param>
        /// <param name="type">A <see cref="System.Type"/> to set the <see cref="Type"/> property equal to.</param>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="expression"/> or <paramref name="type"/> is null.</exception>
        ...
        /// <returns>A <see cref="UnaryExpression"/> that has the <see cref="NodeType"/> property equal to <see cref="ExpressionType.ConvertChecked"/> and the <see cref="UnaryExpression.Operand"/>, <see cref="Type"/>, and <see cref="UnaryExpression.Method"/> properties set to the specified values.</returns>
        /// <param name="expression">An <see cref="Expression"/> to set the <see cref="UnaryExpression.Operand"/> property equal to.</param>
        /// <param name="type">A <see cref="System.Type"/> to set the <see cref="Type"/> property equal to.</param>
        /// <param name="method">A <see cref="MethodInfo"/> to set the <see cref="UnaryExpression.Method"/> property equal to.</param>
        /// <exception cref="ArgumentNullException">
        ...
        /// <returns>A <see cref="UnaryExpression"/> that has the <see cref="NodeType"/> property equal to <see cref="ExpressionType.TypeAs"/> and the <see cref="UnaryExpression.Operand"/> and <see cref="Type"/> properties set to the specified values.</returns>
        /// <param name="expression">An <see cref="Expression"/> to set the <see cref="UnaryExpression.Operand"/> property equal to.</param>
        /// <param name="type">A <see cref="System.Type"/> to set the <see cref="Type"/> property equal to.</param>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="expression"/> or <paramref name="type"/> is null.</exception>
    ...
    public sealed class UnaryExpression : Expression
    {
        ...
        private Expression ReduceIndex()
        {
            ...
            index = MakeIndex(temps[0], index.Indexer, ArrayReadOnlyCollection<Expression>.Create(args));
            if (!prefix)
            {
            ...
            return Block(ArrayReadOnlyCollection<ParameterExpression>.Create(temps), ArrayReadOnlyCollection<Expression>.Create(block));
        }
        ...
        private Expression ReduceMember()
        {
            ...
            if (IsPrefix)
            {
                ...
                return Block(
                    ArrayReadOnlyCollection<ParameterExpression>.Create(temp1),
        ...
        private Expression ReduceVariable()
        {
            ...
            return Block(
                ArrayReadOnlyCollection<ParameterExpression>.Create(temp),
                ArrayReadOnlyCollection<Expression>.Create(Assign(temp, Operand), Assign(Operand, FunctionalOp(temp)), temp)
            );
        }
    }
}

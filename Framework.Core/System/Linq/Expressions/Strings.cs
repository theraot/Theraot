...
namespace System.Linq.Expressions
{
    ...
    internal static class Strings
    {
        ...
        /// </summary>
        internal static string InvalidArgumentValueParamName => "Invalid argument value";
        ...
        /// </summary>
        internal static string AmbiguousMatchInExpandoObject(object p0) => SR.Format("More than one key matching '{0}' was found in the ExpandoObject.", p0);
        ...
        /// </summary>
        internal static string BinderNotCompatibleWithCallSite(object p0, object p1, object p2) => SR.Format("The result type '{0}' of the binder '{1}' is not compatible with the result type '{2}' expected by the call site.", p0, p1, p2);
        ...
        /// </summary>
        internal static string DynamicBinderResultNotAssignable(object p0, object p1, object p2) => SR.Format("The result type '{0}' of the dynamic binding produced by binder '{1}' is not compatible with the result type '{2}' expected by the call site.", p0, p1, p2);
        ...
        /// </summary>
        internal static string DynamicBindingNeedsRestrictions(object p0, object p1) => SR.Format("The result of the dynamic binding produced by the object with type '{0}' for the binder '{1}' needs at least one restriction.", p0, p1);
        ...
        /// </summary>
        internal static string DynamicObjectResultNotAssignable(object p0, object p1, object p2, object p3) => SR.Format("The result type '{0}' of the dynamic binding produced by the object with type '{1}' for the binder '{2}' is not compatible with the result type '{3}' expected by the call site.", p0, p1, p2, p3);
        ...
        /// </summary>
        internal static string InvalidMetaObjectCreated(object p0) => SR.Format("An IDynamicMetaObjectProvider {0} created an invalid DynamicMetaObject instance.", p0);
        ...
        /// </summary>
        internal static string KeyDoesNotExistInExpando(object p0) => SR.Format("The specified key '{0}' does not exist in the ExpandoObject.", p0);
        ...
        /// </summary>
        internal static string NotAMemberOfAnyType(object p0) => SR.Format("'{0}' is not a member of any type", p0);
        ...
        /// </summary>
        internal static string SameKeyExistsInExpando(object p0) => SR.Format("An element with the same key '{0}' already exists in the ExpandoObject.", p0);
        ...
        /// </summary>
        internal static string TypeParameterIsNotDelegate(object p0) => SR.Format("Type parameter is {0}. Expected a delegate.", p0);

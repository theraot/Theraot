...
namespace System.Linq.Expressions
{
    ...
    public enum ExpressionType
    {
        ...
        /// <summary>
        ///     A node that represents a cast or conversion operation. If the operation is a numeric conversion, an exception is
        ///     thrown if the converted value does not fit the target type.
        /// </summary>
        ConvertChecked = 11,
        ...
        /// <summary>
        ///     A node that represents a unary plus operation. The result of a predefined unary plus operation is simply the value
        ///     of the operand, but user-defined implementations may have non-trivial results.
        /// </summary>
        UnaryPlus = 29,
        ...
        /// <summary>
        ///     A node that represents an explicit reference or boxing conversion where null reference (Nothing in Visual Basic) is

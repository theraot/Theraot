...
namespace System.Linq.Expressions
{
    public partial class Expression
    {
        ...
        ///     <see cref="MemberBindingType.ListBinding" /> and the <see cref="MemberBinding.Member" /> and
        ///     <see cref="MemberListBinding.Initializers" /> properties set to the specified values.
        /// </returns>
        /// <param name="member">
        ///     A <see cref="MemberInfo" /> that represents a field or property to set the
        ///     <see cref="MemberBinding.Member" /> property equal to.
        /// </param>
        ...
        ///     <paramref name="member" /> is null. -or-One or more elements of <paramref name="initializers" /> is null.
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     <paramref name="member" /> does not represent a field or property.-or-The <see cref="FieldInfo.FieldType" /> or
        ///     <see cref="PropertyInfo.PropertyType" /> of the field or property that <paramref name="member" /> represents does
        ///     not implement <see cref="IEnumerable" />.
        /// </exception>
        ...
        /// <returns>
        ///     A <see cref="MemberListBinding" /> that has the <see cref="MemberBinding.BindingType" /> property equal to
        ///     <see cref="MemberBindingType.ListBinding" />, the <see cref="MemberBinding.Member" /> property set to the
        ///     <see cref="MemberInfo" /> that represents the property accessed in <paramref name="propertyAccessor" />, and
        ///     <see cref="MemberListBinding.Initializers" /> populated with the elements of <paramref name="initializers" />.
        /// </returns>
        /// <param name="propertyAccessor">A <see cref="MethodInfo" /> that represents a property accessor method.</param>
        /// <param name="initializers">
        ///     An array of <see cref="Expressions.ElementInit" /> objects to use to populate the
        ///     <see cref="MemberListBinding.Initializers" /> collection.
        /// </param>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="propertyAccessor" /> is null. -or-One or more elements of <paramref name="initializers" /> is null.
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     <paramref name="propertyAccessor" /> does not represent a property accessor method.-or-The
        ///     <see cref="PropertyInfo.PropertyType" /> of the property that the method represented by
        ///     <paramref name="propertyAccessor" /> accesses does not implement <see cref="IEnumerable" />.
        /// </exception>
        ...
        ///     objects to use to populate the <see cref="MemberListBinding.Initializers" /> collection.
        /// </param>
        /// <exception cref="ArgumentNullException">

...
namespace System.Linq.Expressions
{
    ...
    public partial class Expression
    {
        ...
        /// <summary>
        ///     Creates a <see cref="CatchBlock" /> representing a catch statement with a reference to the caught object for use in
        ///     the handler body.
        /// </summary>
        /// <param name="variable">
        ///     A <see cref="ParameterExpression" /> representing a reference to the <see cref="Exception" />
        ///     object caught by this handler.
        /// </param>
        /// <param name="body">The body of the catch statement.</param>
        /// <returns>The created <see cref="CatchBlock" />.</returns>

...
namespace Theraot.Threading
{
    public struct VersionToken : IComparable<VersionToken>, IEquatable<VersionToken>
    {
        ...
        internal VersionToken(VersionProvider provider)
        {
            ...
            _target = null;
            _provider = provider;
            _hashCode = provider.GetHashCode();
        }

        internal VersionToken(VersionProvider provider, VersionTarget target, long number)
        {
            _provider = provider;
            _target = target;
            _number = number;
        ...
        {
            return Interlocked.Exchange(ref _provider, other._provider) != other._provider || Interlocked.Exchange(ref _target, other._target) != other._target || Interlocked.Exchange(ref _number, other._number) != other._number;
        }
        ...
        public bool Update()
        {
            ...
            var newTarget = _provider.Target;
            var newNumber = newTarget.Number;
            return Interlocked.Exchange(ref _target, newTarget) != newTarget || Interlocked.Exchange(ref _number, newNumber) != newNumber;
        }
        ...
        {
            return CompareTo(other) < 0 && (Interlocked.Exchange(ref _provider, other._provider) != other._provider || Interlocked.Exchange(ref _target, other._target) != other._target || Interlocked.Exchange(ref _number, other._number) != other._number);
        }

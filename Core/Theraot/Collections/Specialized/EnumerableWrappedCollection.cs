...
namespace Theraot.Collections.Specialized
{
    ...
    public sealed class EnumerableWrappedCollection<T> : IReadOnlyCollection<T>, IExtendedReadOnlyCollection<T>, IEnumerable<T>, IExtendedCollection<T>
    {
        private readonly Func<int> _count;
        private readonly IEnumerable<T> _wrapped;

        public EnumerableWrappedCollection(IEnumerable<T> wrapped, Func<int> count)
        {

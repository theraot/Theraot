...
namespace Theraot.Core
{
	...
	public class StringProcessor
	{
		...
		/// <exception cref="ArgumentNullException">The targets collection is null.</exception>
		/// <exception cref="ArgumentException">Found nulls in the targets collection.</exception>
		public void Skip(IEnumerable<string> targets)
		{
			if (targets == null)
			{
				throw new ArgumentNullException("targets", "The targets collection is null.");
		...
		/// <param name="target">The string to look for.</param>
		/// <exception cref="ArgumentNullException">The target string is null.</exception>
		public void SkipBackBafore(string target)
		{
			SkipBackBafore(target, StringComparison.Ordinal);
		}
		...
		/// <param name="stringComparison">One of the enumeration values that specifies the rules for the search.</param>
		/// <exception cref="ArgumentNullException">The target string is null.</exception>
		public void SkipBackBafore(string target, StringComparison stringComparison)
		{
			if (target == null)
			{
				throw new ArgumentNullException("target", "The target string is null.");
		...
		/// </summary>
		/// <param name="target">The character to look for.</param>
		public void SkipBackBafore(char target)
		{
		...
		/// <param name="target">The string to look for.</param>
		/// <exception cref="ArgumentNullException">The target string is null.</exception>
		public void SkipBackTo(string target)
		{
			SkipBackTo(target, StringComparison.Ordinal);
		}
		...
		/// <param name="stringComparison">One of the enumeration values that specifies the rules for the search.</param>
		/// <exception cref="ArgumentNullException">The target string is null.</exception>
		public void SkipBackTo(string target, StringComparison stringComparison)
		{
			if (target == null)
			{
				throw new ArgumentNullException("target", "The target string is null.");
		...
		/// </summary>
		/// <param name="target">The character to look for.</param>
		public void SkipBackTo(char target)
		{
			var position = _string.LastIndexOf(target, _position);
			if (position != -1)
			{
		...
		{
			SkipUntil(target, StringComparison.Ordinal);
		}
		...
		/// <param name="stringComparison">One of the enumeration values that specifies the rules for the search.</param>
		/// <exception cref="ArgumentNullException">The target string is null.</exception>
		public void SkipUntil(string target, StringComparison stringComparison)
		{
			if (target == null)
			{
				throw new ArgumentNullException("target", "The target string is null.");
		...
		{
			var position = _string.IndexOf(target, _position);
			_position = position != -1 ? position : _length;
		}
		...
		/// <exception cref="ArgumentNullException">The targets collection is null.</exception>
		/// <exception cref="ArgumentException">Found nulls in the targets collection.</exception>
		public void SkipUntil(IEnumerable<string> targets)
		{
			SkipUntil(targets, StringComparison.Ordinal);
		}
		...
		/// <exception cref="ArgumentNullException">The targets collection is null.</exception>
		/// <exception cref="ArgumentException">Found nulls in the targets collection.</exception>
		public void SkipUntil(IEnumerable<string> targets, StringComparison stringComparison)
		{
			if (targets == null)
			{
				throw new ArgumentNullException("targets", "The targets collection is null.");
			...
			_position = all ? _length : bestPosition;
		}
		...
		/// <exception cref="ArgumentNullException">The targets collection is null.</exception>
		/// <exception cref="ArgumentException">Found nulls in the targets collection.</exception>
		public void SkipUntil(IEnumerable<string> targets, out string found)
		{
			SkipUntil(targets, out found, StringComparison.Ordinal);
		}
		...
		/// <exception cref="ArgumentNullException">The targets collection is null.</exception>
		/// <exception cref="ArgumentException">Found nulls in the targets collection.</exception>
		public void SkipUntil(IEnumerable<string> targets, out string found, StringComparison stringComparison)
		{
			if (targets == null)
			{
				throw new ArgumentNullException("targets", "The targets collection is null.");
		...
		/// <exception cref="ArgumentNullException">The targets collection is null.</exception>
		/// <exception cref="ArgumentException">Found nulls in the targets collection.</exception>
		public void SkipUntil(IEnumerable<char> targets)
		{
			if (targets == null)
			{
				throw new ArgumentNullException("targets");
		...
		/// <exception cref="ArgumentNullException">The targets collection is null.</exception>
		/// <exception cref="ArgumentException">Found nulls in the targets collection.</exception>
		public void SkipUntil(char[] targets)
		{
			if (targets == null)
			{
				throw new ArgumentNullException("targets");
			}
			PrivateSkipUntil(targets);
		}
		...
		/// <param name="target">The string to look for.</param>
		/// <exception cref="ArgumentNullException">The target string is null.</exception>
		public void SkipUntilAfter(string target)
		{
			SkipUntilAfter(target, StringComparison.Ordinal);
		}
		...
		/// <param name="stringComparison">One of the enumeration values that specifies the rules for the search.</param>
		/// <exception cref="ArgumentNullException">The target string is null.</exception>
		public void SkipUntilAfter(string target, StringComparison stringComparison)
		{
			if (target == null)
			{
				throw new ArgumentNullException("target", "The target string is null.");
		...
		/// </summary>
		/// <param name="target">The character to look for.</param>
		public void SkipUntilAfter(char target)
		{
			var position = _string.IndexOf(target, _position);
			if (position != -1)
			{
		...
		/// <param name="target">The character to look for.</param>
		public void SkipWhile(char target)
		{
			if (_position == _length)
			{
				return;
		...
		/// <exception cref="ArgumentNullException">The targets collection is null.</exception>
		/// <exception cref="ArgumentException">Found nulls in the targets collection.</exception>
		public void SkipWhile(IEnumerable<char> targets)
		{
			if (targets == null)
			{
				throw new ArgumentNullException("targets");
		...
		private void PrivateSkipUntil(char[] targets)
		{
			var position = _string.IndexOfAny(targets, _position);
			_position = position == -1 ? _length : position;
		}
	}
}
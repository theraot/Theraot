...
namespace Theraot.Threading
{
    ...
    {
        private LazyNeedle<NoTrackingThreadLocal<Tuple<ExtendedQueue<Action>, Guard>>> _workQueue;

        public ReentryGuard()
        {
            _workQueue = new LazyNeedle<NoTrackingThreadLocal<Tuple<ExtendedQueue<Action>, Guard>>>
            (

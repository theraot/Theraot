...
namespace Tests.ExpressionCompiler.Unary
{
    public static class UnaryBitwiseNotNullableTests
    {
        ...
        private static void VerifyBitwiseNotNullableUShort(ushort? value)
        {
            ...
            Assert.AreEqual((ushort?)(~value), f());
        }

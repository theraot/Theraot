...
namespace Tests.ExpressionCompiler.Lambda
{
    public static class LambdaMultiplyTests
    {
        ...
        [Test]
        public static void LambdaMultiplyDecimalTest()
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                ...
                {
                    VerifyMultiplyDecimal(values[i], values[j]);
                }
            }
        }

        [Test]
        public static void LambdaMultiplyDoubleTest()
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                for (int j = 0; j < values.Length; j++)
                {
                    VerifyMultiplyDouble(values[i], values[j]);
                }
            }
        }

        [Test]
        public static void LambdaMultiplyFloatTest()
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                for (int j = 0; j < values.Length; j++)
                {
                    VerifyMultiplyFloat(values[i], values[j]);
                }
            }
        }

        [Test]
        public static void LambdaMultiplyIntTest()
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                for (int j = 0; j < values.Length; j++)
                {
                    VerifyMultiplyInt(values[i], values[j]);
                }
            }
        }

        [Test]
        public static void LambdaMultiplyLongTest()
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                for (int j = 0; j < values.Length; j++)
                {
                    VerifyMultiplyLong(values[i], values[j]);
                }
            }
        }

        [Test]
        public static void LambdaMultiplyShortTest()
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                for (int j = 0; j < values.Length; j++)
                {
                    VerifyMultiplyShort(values[i], values[j]);
                }
            }
        }

        [Test]
        public static void LambdaMultiplyUIntTest()
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                for (int j = 0; j < values.Length; j++)
                {
                    VerifyMultiplyUInt(values[i], values[j]);
                }
            }
        }

        [Test]
        public static void LambdaMultiplyULongTest()
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                for (int j = 0; j < values.Length; j++)
                {
                    VerifyMultiplyULong(values[i], values[j]);
                }
            }
        }

        [Test]
        public static void LambdaMultiplyUShortTest()
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                for (int j = 0; j < values.Length; j++)
                {
                    VerifyMultiplyUShort(values[i], values[j]);
                }
            }
        }
        ...
        private static void VerifyMultiplyDecimal(decimal a, decimal b)
        {
            ...
            if (f1Ex != null || f2Ex != null || f3Ex != null || f4Ex != null || f5Ex != null || f6Ex != null || csEx != null)
            {
                ...
                Assert.NotNull(f6Ex);
                Assert.NotNull(csEx);
                Assert.AreEqual(csEx.GetType(), f1Ex.GetType());
                Assert.AreEqual(csEx.GetType(), f2Ex.GetType());
                Assert.AreEqual(csEx.GetType(), f3Ex.GetType());
                Assert.AreEqual(csEx.GetType(), f4Ex.GetType());
                Assert.AreEqual(csEx.GetType(), f5Ex.GetType());
                Assert.AreEqual(csEx.GetType(), f6Ex.GetType());
            }
            else
            {
                Assert.AreEqual(csResult, f1Result);
                Assert.AreEqual(csResult, f2Result);
                Assert.AreEqual(csResult, f3Result);
                Assert.AreEqual(csResult, f4Result);
                Assert.AreEqual(csResult, f5Result);
                Assert.AreEqual(csResult, f6Result);
            }
        }
        ...
        private static void VerifyMultiplyDouble(double a, double b)
        {
        ...
        private static void VerifyMultiplyFloat(float a, float b)
        {
        ...
        private static void VerifyMultiplyInt(int a, int b)
        {
        ...
        private static void VerifyMultiplyLong(long a, long b)
        {
        ...
        private static void VerifyMultiplyShort(short a, short b)
        {
        ...
        private static void VerifyMultiplyUInt(uint a, uint b)
        {
        ...
        private static void VerifyMultiplyULong(ulong a, ulong b)
        {
        ...
        private static void VerifyMultiplyUShort(ushort a, ushort b)
        {

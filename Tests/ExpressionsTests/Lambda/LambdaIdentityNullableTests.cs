...
namespace Tests.ExpressionCompiler.Lambda
{
    public static class LambdaIdentityNullableTests
    {
        ...
        [Test]
        public static void CheckLambdaIdentityNullableBoolTest()
        {
            foreach (bool? value in new bool?[] { null, true, false })
            {
                VerifyIdentityNullableBool(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableByteTest()
        {
            foreach (byte? value in new byte?[] { null, 0, 1, byte.MaxValue })
            {
                VerifyIdentityNullableByte(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableCharTest()
        {
            foreach (char? value in new char?[] { null, '\0', '\b', 'A', '\uffff' })
            {
                VerifyIdentityNullableChar(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableDecimalTest()
        {
            foreach (decimal? value in new decimal?[] { null, decimal.Zero, decimal.One, decimal.MinusOne, decimal.MinValue, decimal.MaxValue })
            {
                VerifyIdentityNullableDecimal(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableDoubleTest()
        {
            ...
            {
                VerifyIdentityNullableDouble(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableEnumTest()
        {
            foreach (E? value in new E?[] { null, (E)0, E.A, E.B, (E)int.MaxValue, (E)int.MinValue })
            {
                VerifyIdentityNullableEnum(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableEnumLongTest()
        {
            foreach (El? value in new El?[] { null, (El)0, El.A, El.B, (El)long.MaxValue, (El)long.MinValue })
            {
                VerifyIdentityNullableEnumLong(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableFloatTest()
        {
            ...
            {
                VerifyIdentityNullableFloat(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableIntTest()
        {
            foreach (int? value in new int?[] { null, 0, 1, -1, int.MinValue, int.MaxValue })
            {
                VerifyIdentityNullableInt(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableLongTest()
        {
            foreach (long? value in new long?[] { null, 0, 1, -1, long.MinValue, long.MaxValue })
            {
                VerifyIdentityNullableLong(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableStructTest()
        {
            foreach (S? value in new S?[] { null, default(S), new S() })
            {
                VerifyIdentityNullableStruct(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableSByteTest()
        {
            foreach (sbyte? value in new sbyte?[] { null, 0, 1, -1, sbyte.MinValue, sbyte.MaxValue })
            {
                VerifyIdentityNullableSByte(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableStructWithStringTest()
        {
            foreach (Sc? value in new Sc?[] { null, default(Sc), new Sc(), new Sc(null) })
            {
                VerifyIdentityNullableStructWithString(value);
            }
        }
        ...
        public static void CheckLambdaIdentityNullableStructWithStringAndFieldTest()
        {
            ...
            {
                VerifyIdentityNullableStructWithStringAndField(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableShortTest()
        {
            foreach (short? value in new short?[] { null, 0, 1, -1, short.MinValue, short.MaxValue })
            {
                VerifyIdentityNullableShort(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableStructWithTwoValuesTest()
        {
            foreach (Sp? value in new Sp?[] { null, default(Sp), new Sp(), new Sp(5, 5.0) })
            {
                VerifyIdentityNullableStructWithTwoValues(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableStructWithValueTest()
        {
            foreach (Ss? value in new Ss?[] { null, default(Ss), new Ss(), new Ss(new S()) })
            {
                VerifyIdentityNullableStructWithValue(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableUIntTest()
        {
            foreach (uint? value in new uint?[] { null, 0, 1, uint.MaxValue })
            {
                VerifyIdentityNullableUInt(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableULongTest()
        {
            foreach (ulong? value in new ulong?[] { null, 0, 1, ulong.MaxValue })
            {
                VerifyIdentityNullableULong(value);
            }
        }

        [Test]
        public static void CheckLambdaIdentityNullableUShortTest()
        {
            foreach (ushort? value in new ushort?[] { null, 0, 1, ushort.MaxValue })
            {
                VerifyIdentityNullableUShort(value);
            }
        }
        ...
        private static void CheckLambdaIdentityNullableGenericWithStructRestrictionHelper<Ts>() where Ts : struct
        {
            foreach (Ts? value in new Ts?[] { default(Ts), new Ts() })
            {
                VerifyIdentityNullableGenericWithStructRestriction<Ts>(value);
            }
        }
        ...
        private static void VerifyIdentityNullableBool(bool? value)
        {
            ...
            Assert.AreEqual(value, f1());
            Assert.AreEqual(value, f2(value)());
            Assert.AreEqual(value, f3(value));
            Assert.AreEqual(value, f4()(value));
        }

        private static void VerifyIdentityNullableByte(byte? value)
        {
        ...
        private static void VerifyIdentityNullableChar(char? value)
        {
        ...
        private static void VerifyIdentityNullableDecimal(decimal? value)
        {
        ...
        private static void VerifyIdentityNullableDouble(double? value)
        {
        ...
        private static void VerifyIdentityNullableEnum(E? value)
        {
        ...
        private static void VerifyIdentityNullableEnumLong(El? value)
        {
        ...
        private static void VerifyIdentityNullableFloat(float? value)
        {
        ...
        private static void VerifyIdentityNullableInt(int? value)
        {
        ...
        private static void VerifyIdentityNullableLong(long? value)
        {
        ...
        private static void VerifyIdentityNullableStruct(S? value)
        {
        ...
        private static void VerifyIdentityNullableSByte(sbyte? value)
        {
        ...
        private static void VerifyIdentityNullableStructWithString(Sc? value)
        {
        ...
        private static void VerifyIdentityNullableStructWithStringAndField(Scs? value)
        {
        ...
        private static void VerifyIdentityNullableShort(short? value)
        {
        ...
        private static void VerifyIdentityNullableStructWithTwoValues(Sp? value)
        {
        ...
        private static void VerifyIdentityNullableStructWithValue(Ss? value)
        {
        ...
        private static void VerifyIdentityNullableUInt(uint? value)
        {
        ...
        private static void VerifyIdentityNullableULong(ulong? value)
        {
        ...
        private static void VerifyIdentityNullableUShort(ushort? value)
        {
        ...
        private static void VerifyIdentityNullableGenericWithStructRestriction<Ts>(Ts? value) where Ts : struct
        {

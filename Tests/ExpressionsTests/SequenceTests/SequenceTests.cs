...
namespace Tests
{
    public class Sequence_Tests
    {
        ...
        public static void GroupBywithResultSelector()
        {
            ...
            {
                Assert.AreEqual(5, e.Element.Count());
                foreach (var ele in e.Element)
                    Assert.AreEqual(ele, 'q');
            }
        }
        ...
        public static void BasicAggregate()
        {
            ...
            Assert.AreEqual(120, ints.Aggregate((current, i) => current * i));
        }
        ...
        public static void DistinctWithNulls()
        {
            ...
            Assert.AreEqual(2, distinct[1]);
            Assert.Null(distinct[2]);
            Assert.AreEqual(4, distinct[3]);
        }
        ...
        {
            Assert.AreEqual(6, Enumerable.Range(0, 10).ElementAtOrDefault(6));
            Assert.AreEqual(default(int), Enumerable.Range(0, 10).ElementAtOrDefault(10));
            Assert.AreEqual(default(int), Enumerable.Range(0, 10).ElementAtOrDefault(-1));

            Assert.AreEqual(9, Enumerable.Range(0, 10).Last());
            Assert.AreEqual(9, Enumerable.Range(0, 10).LastOrDefault());
            Assert.AreEqual(default(int), Enumerable.Range(0, 0).LastOrDefault());
        }
        ...
        {
            Assert.AreEqual(0, Enumerable.Range(0, 10).Min());
            Assert.AreEqual(9, Enumerable.Range(0, 10).Max());
            Assert.AreEqual(10, Enumerable.Range(0, 10).Count());
            Assert.AreEqual(0, Enumerable.Range(0, 0).Count());
        }
        ...
        public static void MaxMin()
        {
            ...
            Assert.AreEqual(9, MaxMin_NumberSourceInt16().Max());
            Assert.AreEqual(9, MaxMin_NumberSourceInt32().Max());
            Assert.AreEqual(9, MaxMin_NumberSourceInt64().Max());
            Assert.AreEqual(9, MaxMin_NumberSourceUInt16().Max());
            Assert.AreEqual((uint)9, MaxMin_NumberSourceUInt32().Max());
            Assert.AreEqual((ulong)9, MaxMin_NumberSourceUInt64().Max());
            Assert.AreEqual(9, MaxMin_NumberSourceSingle().Max());
            Assert.AreEqual(9, MaxMin_NumberSourceDouble().Max());
            Assert.AreEqual(9, MaxMin_NumberSourceDecimal().Max());

            Assert.AreEqual(0, MaxMin_NumberSourceInt16().Min());
            Assert.AreEqual(0, MaxMin_NumberSourceInt32().Min());
            Assert.AreEqual(0, MaxMin_NumberSourceInt64().Min());
            Assert.AreEqual(0, MaxMin_NumberSourceUInt16().Min());
            Assert.AreEqual((uint)0, MaxMin_NumberSourceUInt32().Min());
            Assert.AreEqual((ulong)0, MaxMin_NumberSourceUInt64().Min());
            Assert.AreEqual(0, MaxMin_NumberSourceSingle().Min());
            Assert.AreEqual(0, MaxMin_NumberSourceDouble().Min());
            Assert.AreEqual(0, MaxMin_NumberSourceDecimal().Min());


            Assert.AreEqual((short?)9, MaxMin_NullableNumberSourceInt16().Max());
            Assert.AreEqual(9, MaxMin_NullableNumberSourceInt32().Max());
            Assert.AreEqual(9, MaxMin_NullableNumberSourceInt64().Max());
            Assert.AreEqual((ushort?)9, MaxMin_NullableNumberSourceUInt16().Max());
            Assert.AreEqual((uint?)9, MaxMin_NullableNumberSourceUInt32().Max());
            Assert.AreEqual((ulong?)9, MaxMin_NullableNumberSourceUInt64().Max());
            Assert.AreEqual(9, MaxMin_NullableNumberSourceSingle().Max());
            Assert.AreEqual(9, MaxMin_NullableNumberSourceDouble().Max());
            Assert.AreEqual(9, MaxMin_NullableNumberSourceDecimal().Max());

            Assert.AreEqual((short?)0, MaxMin_NullableNumberSourceInt16().Min());
            Assert.AreEqual(0, MaxMin_NullableNumberSourceInt32().Min());
            Assert.AreEqual(0, MaxMin_NullableNumberSourceInt64().Min());
            Assert.AreEqual((ushort?)0, MaxMin_NullableNumberSourceUInt16().Min());
            Assert.AreEqual((uint?)0, MaxMin_NullableNumberSourceUInt32().Min());
            Assert.AreEqual((ulong?)0, MaxMin_NullableNumberSourceUInt64().Min());
            Assert.AreEqual(0, MaxMin_NullableNumberSourceSingle().Min());
            Assert.AreEqual(0, MaxMin_NullableNumberSourceDouble().Min());
            Assert.AreEqual(0, MaxMin_NullableNumberSourceDecimal().Min());
            ...
            Assert.AreEqual(9, MaxMin_NumberSourceInt16().Max(item => item));
            Assert.AreEqual(9, MaxMin_NumberSourceInt32().Max(item => item));
            Assert.AreEqual(9, MaxMin_NumberSourceInt64().Max(item => item));
            Assert.AreEqual(9, MaxMin_NumberSourceUInt16().Max(item => item));
            Assert.AreEqual((uint)9, MaxMin_NumberSourceUInt32().Max(item => item));
            Assert.AreEqual((ulong)9, MaxMin_NumberSourceUInt64().Max(item => item));
            Assert.AreEqual(9, MaxMin_NumberSourceSingle().Max(item => item));
            Assert.AreEqual(9, MaxMin_NumberSourceDouble().Max(item => item));
            Assert.AreEqual(9, MaxMin_NumberSourceDecimal().Max(item => item));

            Assert.AreEqual(0, MaxMin_NumberSourceInt16().Min(item => item));
            Assert.AreEqual(0, MaxMin_NumberSourceInt32().Min(item => item));
            Assert.AreEqual(0, MaxMin_NumberSourceInt64().Min(item => item));
            Assert.AreEqual(0, MaxMin_NumberSourceUInt16().Min(item => item));
            Assert.AreEqual((uint)0, MaxMin_NumberSourceUInt32().Min(item => item));
            Assert.AreEqual((ulong)0, MaxMin_NumberSourceUInt64().Min(item => item));
            Assert.AreEqual(0, MaxMin_NumberSourceSingle().Min(item => item));
            Assert.AreEqual(0, MaxMin_NumberSourceDouble().Min(item => item));
            Assert.AreEqual(0, MaxMin_NumberSourceDecimal().Min(item => item));


            Assert.AreEqual((short?)9, MaxMin_NullableNumberSourceInt16().Max(item => item));
            Assert.AreEqual(9, MaxMin_NullableNumberSourceInt32().Max(item => item));
            Assert.AreEqual(9, MaxMin_NullableNumberSourceInt64().Max(item => item));
            Assert.AreEqual((ushort?)9, MaxMin_NullableNumberSourceUInt16().Max(item => item));
            Assert.AreEqual((ushort?)9, MaxMin_NullableNumberSourceUInt32().Max(item => item));
            Assert.AreEqual((ulong?)9, MaxMin_NullableNumberSourceUInt64().Max(item => item));
            Assert.AreEqual(9, MaxMin_NullableNumberSourceSingle().Max(item => item));
            Assert.AreEqual(9, MaxMin_NullableNumberSourceDouble().Max(item => item));
            Assert.AreEqual(9, MaxMin_NullableNumberSourceDecimal().Max(item => item));

            Assert.AreEqual((short?)0, MaxMin_NullableNumberSourceInt16().Min(item => item));
            Assert.AreEqual(0, MaxMin_NullableNumberSourceInt32().Min(item => item));
            Assert.AreEqual(0, MaxMin_NullableNumberSourceInt64().Min(item => item));
            Assert.AreEqual((ushort?)0, MaxMin_NullableNumberSourceUInt16().Min(item => item));
            Assert.AreEqual((uint?)0, MaxMin_NullableNumberSourceUInt32().Min(item => item));
            Assert.AreEqual((ulong?)0, MaxMin_NullableNumberSourceUInt64().Min(item => item));
            Assert.AreEqual(0, MaxMin_NullableNumberSourceSingle().Min(item => item));
            Assert.AreEqual(0, MaxMin_NullableNumberSourceDouble().Min(item => item));
            Assert.AreEqual(0, MaxMin_NullableNumberSourceDecimal().Min(item => item));
        }

        [Test]
        public static void Lookup()
        {
            Assert.AreEqual(9, Enumerable.Range(0, 10).ToDictionary(t => t.ToString())["9"]);

            ILookup<string, int> lookup = Enumerable.Range(0, 10).ToLookup(t => t.ToString(), t => t, EqualityComparer<string>.Default);

            Assert.AreEqual(1, ((ICollection<int>)lookup["9"]).Count);

            Assert.AreEqual(1, ((ICollection<int>)lookup["9"]).Count);

            Assert.AreEqual(9, ((IList<int>)lookup["9"])[0]);
    ...
    public class Expression_Tests
    {
        ...
        public static void ListInit()
        {
            ...
            {
                Assert.AreEqual("argument", ane.ParamName);
            }
        ...
        public static void Lambda()
        {
            ...
            Assert.AreEqual(typeof(Func<int, double, decimal, Func<int, double, decimal, int>>),
            ...
            Assert.AreEqual(typeof(Func<int, double, decimal, short, Func<int, double, decimal, short, int>>),
        ...
        public static void Arrays()
        {
            ...
            Assert.NotNull(aex1);
            Assert.AreEqual(aex1.NodeType, ExpressionType.NewArrayBounds);

            Expression<Func<int[], int>> exp2 = (i) => i.Length;
            UnaryExpression uex2 = exp2.Body as UnaryExpression;
            Assert.NotNull(uex2);
            Assert.AreEqual(uex2.NodeType, ExpressionType.ArrayLength);
        }
        ...
        public static void CheckedExpressions()
        {
            ...
            Assert.NotNull(bex);
            Assert.AreEqual(bex.NodeType, ExpressionType.Add);

            exp = (a, b) => checked(a + b);
            bex = exp.Body as BinaryExpression;
            Assert.NotNull(bex);
            Assert.AreEqual(bex.NodeType, ExpressionType.AddChecked);

            exp = (a, b) => a * b;
            bex = exp.Body as BinaryExpression;
            Assert.NotNull(bex);
            Assert.AreEqual(bex.NodeType, ExpressionType.Multiply);

            exp = (a, b) => checked(a * b);
            bex = exp.Body as BinaryExpression;
            Assert.NotNull(bex);
            Assert.AreEqual(bex.NodeType, ExpressionType.MultiplyChecked);

            Expression<Func<double, int>> exp2 = (a) => (int)a;
            UnaryExpression uex = exp2.Body as UnaryExpression;
            Assert.NotNull(uex);
            Assert.AreEqual(uex.NodeType, ExpressionType.Convert);

            exp2 = (a) => checked((int)a);
            uex = exp2.Body as UnaryExpression;
            Assert.NotNull(uex);
            Assert.AreEqual(uex.NodeType, ExpressionType.ConvertChecked);
        }
        ...
        public static void VirtualCallExpressions()
        {
            ...
            Assert.NotNull(mc);
            Assert.AreEqual(ExpressionType.Call, mc.NodeType);
        }
        ...
        public static void AssertIsCoercion(UnaryExpression u, string opName, Type expected)
        {
            ...
            Assert.NotNull(u.Method);
            Assert.AreEqual(opName, u.Method.Name);
            Assert.AreEqual(expected, u.Type);
        }
        ...
        public static void TestFuncLambda()
        {
            ...
            Assert.AreEqual(typeof(Func<NWindProxy.Customer, string>), lambda.Type);
        }
        ...
        public static void TestGetFuncType()
        {
            ...
            Assert.AreEqual(1, type.GetGenericArguments().Length);
            Assert.AreEqual(typeof(int), type.GetGenericArguments()[0]);

            // 2 type arg Func
            type = Expression.GetFuncType(new Type[] { typeof(int), typeof(string) });
            Assert.True(type.IsGenericType);
            Assert.AreEqual(typeof(Func<,>), type.GetGenericTypeDefinition());
            Assert.AreEqual(typeof(int), type.GetGenericArguments()[0]);
            Assert.AreEqual(typeof(string), type.GetGenericArguments()[1]);
            ...
            Assert.AreEqual(typeof(int), type.GetGenericArguments()[1]);
            Assert.AreEqual(typeof(decimal), type.GetGenericArguments()[2]);
            ...
            Assert.AreEqual(typeof(int), type.GetGenericArguments()[1]);
            Assert.AreEqual(typeof(decimal), type.GetGenericArguments()[2]);
            Assert.AreEqual(typeof(float), type.GetGenericArguments()[3]);

            // 5 type arg Func
            type = Expression.GetFuncType(new Type[] { typeof(NWindProxy.Customer), typeof(string), typeof(int), typeof(decimal), typeof(float) });
            Assert.True(type.IsGenericType);
            Assert.AreEqual(typeof(Func<,,,,>), type.GetGenericTypeDefinition());
            Assert.AreEqual(typeof(NWindProxy.Customer), type.GetGenericArguments()[0]);
            Assert.AreEqual(typeof(string), type.GetGenericArguments()[1]);
            Assert.AreEqual(typeof(int), type.GetGenericArguments()[2]);
            Assert.AreEqual(typeof(decimal), type.GetGenericArguments()[3]);
            Assert.AreEqual(typeof(float), type.GetGenericArguments()[4]);
        }
        ...
        public static void TestPropertiesAndFieldsByName()
        {
            ...
            Assert.AreEqual("ContactName", Expression.PropertyOrField(p, "contactName").Member.Name);
            Assert.AreEqual("ContactName", Expression.Field(p, "CONTACTNAME").Member.Name);

            Expression t = Expression.Parameter(typeof(Expression_Tests), "t");
            Assert.AreEqual("IsFunky", Expression.PropertyOrField(t, "IsFunky").Member.Name);
            Assert.AreEqual("IsFunky", Expression.PropertyOrField(t, "isFunky").Member.Name);
            Assert.AreEqual("IsFunky", Expression.PropertyOrField(t, "isfunky").Member.Name);
            Assert.True(typeof(PropertyInfo).IsAssignableFrom(Expression.PropertyOrField(t, "isfunky").Member.GetType()));
            Assert.AreEqual("IsFunky", Expression.Property(t, "IsFunky").Member.Name);
            Assert.AreEqual("IsFunky", Expression.Property(t, "isFunky").Member.Name);
            Assert.AreEqual("IsFunky", Expression.Property(t, "ISFUNKY").Member.Name);
        ...
        public static void TestCallInstanceMethodsByName()
        {
            ...
            Assert.AreEqual(typeof(int), mc1.Method.GetParameters()[0].ParameterType);
            MethodCallExpression mc2 = Expression.Call(Expression.Constant(obj), "Somemethod", null, Expression.Constant("Five"));
            Assert.AreEqual(typeof(string), mc2.Method.GetParameters()[0].ParameterType);
            ...
            Assert.AreEqual(typeof(int), mc3.Method.GetParameters()[0].ParameterType);
            Assert.AreEqual(typeof(string), mc3.Method.GetParameters()[1].ParameterType);
        }
        ...
        private static void CheckMethod(string name, Expression expr)
        {
            ...
            Assert.AreEqual(name, mc.Method.Name);

            Assert.AreEqual(typeof(Queryable), mc.Method.DeclaringType);
        }
    }
    ...
    public class Queryable_Tests
    {
        ...
        public static void QueryableMethods()
        {
            ...
            Assert.AreEqual(21, q.Aggregate((a, b) => a + b));
            Assert.AreEqual(21, q.Aggregate(0, (a, b) => a + b));
            Assert.AreEqual("21", q.Aggregate(0, (a, b) => a + b, (r) => r.ToString()));
            ...
            Assert.AreEqual(6, q.Cast<object>().Count());
            Assert.AreEqual(12, q.Concat(q).Count());
            Assert.AreEqual(12, s.Concat(q).Count());
            Assert.AreEqual(12, q.Concat(s).Count());
            Assert.AreEqual(3, q.Count(x => x < 4));
            Assert.True(q.Contains(3));
            Assert.False(q.Contains(9));
            Assert.False(qe.Contains(5));
            Assert.AreEqual(6, q.Distinct().Count());
            Assert.AreEqual(1, qe.DefaultIfEmpty().Count());
            Assert.AreEqual(4, q.ElementAt(3));
            Assert.AreEqual(4, q.ToList().ElementAt(3));
            Assert.AreEqual(4, s.ElementAt(3));
            Assert.AreEqual(4, s.ToList().ElementAt(3));
            Assert.AreEqual(0, q.ElementAtOrDefault(10));
            Assert.AreEqual(0, q.ToList().ElementAtOrDefault(10));
            Assert.AreEqual(4, s.ElementAtOrDefault(3));
            Assert.AreEqual(4, s.ToList().ElementAtOrDefault(3));
            Assert.AreEqual(0, s.ElementAtOrDefault(10));
            Assert.AreEqual(0, s.ToList().ElementAtOrDefault(10));
            ...
            Assert.AreEqual(4, q.Except(q2).Count());
            Assert.AreEqual(4, s.Except(q2).Count());
            Assert.AreEqual(4, q.Except(s2).Count());
            Assert.AreEqual(1, q.First());
            Assert.AreEqual(4, q.First(x => x > 3));
            Assert.AreEqual(4, ((IEnumerable<int>)q).First(x => x > 3));
            Assert.AreEqual(0, qe.FirstOrDefault());
            Assert.AreEqual(1, q.FirstOrDefault());
            Assert.AreEqual(1, q.ToList().FirstOrDefault());
            Assert.AreEqual(1, Enumerable.Range(1, 6).FirstOrDefault());
            Assert.AreEqual(1, Enumerable.Range(1, 6).ToList().FirstOrDefault());
            Assert.AreEqual(6, q.FirstOrDefault(x => x > 5));
            Assert.AreEqual(0, q.FirstOrDefault(x => x > 10));
            Assert.AreEqual(6, q.ToList().FirstOrDefault(x => x > 5));
            Assert.AreEqual(0, q.ToList().FirstOrDefault(x => x > 10));
            Assert.AreEqual(6, Enumerable.Range(1, 6).FirstOrDefault(x => x > 5));
            Assert.AreEqual(0, Enumerable.Range(1, 6).FirstOrDefault(x => x > 10));
            Assert.AreEqual(4, q.GroupBy(x => x / 2).Count());
            Assert.AreEqual(3, q.GroupBy(x => names[x].Length, x => x).Count());
            Assert.AreEqual(6, q.GroupBy(x => names[x]).Count());
            Assert.AreEqual(6, q.GroupBy(x => names[x], x => x, comp).Count());
            Assert.AreEqual(2, q.Intersect(q2).Count());
            Assert.AreEqual(6, q.Last());
            Assert.AreEqual(6, q.Last(x => x > 3));
            Assert.AreEqual(0, qe.LastOrDefault());
            Assert.AreEqual(6, s.LastOrDefault());
            Assert.AreEqual(6, q.LastOrDefault());
            Assert.AreEqual(6, q.ToList().LastOrDefault());
            Assert.AreEqual(6, Enumerable.Range(1, 6).LastOrDefault());
            Assert.AreEqual(6, q.LastOrDefault(x => x > 5));
            Assert.AreEqual(0, q.LastOrDefault(x => x > 10));
            Assert.AreEqual(6, q.ToList().LastOrDefault(x => x > 5));
            Assert.AreEqual(0, q.ToList().LastOrDefault(x => x > 10));
            Assert.AreEqual(6, Enumerable.Range(1, 6).ToList().LastOrDefault(x => x > 5));
            Assert.AreEqual(0, Enumerable.Range(1, 6).ToList().LastOrDefault(x => x > 10));
            Assert.AreEqual(6L, q.LongCount());
            Assert.AreEqual(3L, q.LongCount(x => x <= 3));
            Assert.AreEqual(6, q.Max());
            Assert.AreEqual(36, q.Max(x => x * x));
            Assert.AreEqual(6, q.Reverse().Max());
            Assert.AreEqual(36, q.Reverse().Max(x => x * x));
            Assert.AreEqual(1, q.Min());
            Assert.AreEqual(1, q.Min(x => x * x));
            Assert.AreEqual(1, q.Reverse().Min());
            Assert.AreEqual(1, q.Reverse().Min(x => x * x));

            Assert.AreEqual(6, sInt.Max());
            Assert.AreEqual(36, sInt.Max(x => x * x));
            Assert.AreEqual(6, sInt.Reverse().Max());
            Assert.AreEqual(36, sInt.Reverse().Max(x => x * x));
            Assert.AreEqual(1, sInt.Min());
            Assert.AreEqual(1, sInt.Min(x => x * x));
            Assert.AreEqual(1, sInt.Reverse().Min());
            Assert.AreEqual(1, sInt.Reverse().Min(x => x * x));
            Assert.AreEqual(6, sDouble.Max());
            Assert.AreEqual(36, sDouble.Max(x => x * x));
            Assert.AreEqual(6, sDouble.Reverse().Max());
            Assert.AreEqual(36, sDouble.Reverse().Max(x => x * x));
            Assert.AreEqual(1, sDouble.Min());
            Assert.AreEqual(1, sDouble.Min(x => x * x));
            Assert.AreEqual(1, sDouble.Reverse().Min());
            Assert.AreEqual(1, sDouble.Reverse().Min(x => x * x));
            Assert.AreEqual(6, sLong.Max());
            Assert.AreEqual(36, sLong.Max(x => x * x));
            Assert.AreEqual(6, sLong.Reverse().Max());
            Assert.AreEqual(36, sLong.Reverse().Max(x => x * x));
            Assert.AreEqual(1, sLong.Min());
            Assert.AreEqual(1, sLong.Min(x => x * x));
            Assert.AreEqual(1, sLong.Reverse().Min());
            Assert.AreEqual(1, sLong.Reverse().Min(x => x * x));
            Assert.AreEqual(6, sDecimal.Max());
            Assert.AreEqual(36, sDecimal.Max(x => x * x));
            Assert.AreEqual(6, sDecimal.Reverse().Max());
            Assert.AreEqual(36, sDecimal.Reverse().Max(x => x * x));
            Assert.AreEqual(1, sDecimal.Min());
            Assert.AreEqual(1, sDecimal.Min(x => x * x));
            Assert.AreEqual(1, sDecimal.Reverse().Min());
            Assert.AreEqual(1, sDecimal.Reverse().Min(x => x * x));

            Assert.AreEqual(6, snInt.Max());
            Assert.AreEqual(36, snInt.Max(x => x * x));
            Assert.AreEqual(6, snInt.Reverse().Max());
            Assert.AreEqual(36, snInt.Reverse().Max(x => x * x));
            Assert.AreEqual(1, snInt.Min());
            Assert.AreEqual(1, snInt.Min(x => x * x));
            Assert.AreEqual(1, snInt.Reverse().Min());
            Assert.AreEqual(1, snInt.Reverse().Min(x => x * x));
            Assert.AreEqual(6, snDouble.Max());
            Assert.AreEqual(36, snDouble.Max(x => x * x));
            Assert.AreEqual(6, snDouble.Reverse().Max());
            Assert.AreEqual(36, snDouble.Reverse().Max(x => x * x));
            Assert.AreEqual(1, snDouble.Min());
            Assert.AreEqual(1, snDouble.Min(x => x * x));
            Assert.AreEqual(1, snDouble.Reverse().Min());
            Assert.AreEqual(1, snDouble.Reverse().Min(x => x * x));
            Assert.AreEqual(6, snLong.Max());
            Assert.AreEqual(36, snLong.Max(x => x * x));
            Assert.AreEqual(6, snLong.Reverse().Max());
            Assert.AreEqual(36, snLong.Reverse().Max(x => x * x));
            Assert.AreEqual(1, snLong.Min());
            Assert.AreEqual(1, snLong.Min(x => x * x));
            Assert.AreEqual(1, snLong.Reverse().Min());
            Assert.AreEqual(1, snLong.Reverse().Min(x => x * x));
            Assert.AreEqual(6, snDecimal.Max());
            Assert.AreEqual(36, snDecimal.Max(x => x * x));
            Assert.AreEqual(6, snDecimal.Reverse().Max());
            Assert.AreEqual(36, snDecimal.Reverse().Max(x => x * x));
            Assert.AreEqual(1, snDecimal.Min());
            Assert.AreEqual(1, snDecimal.Min(x => x * x));
            Assert.AreEqual(1, snDecimal.Reverse().Min());
            Assert.AreEqual(1, snDecimal.Reverse().Min(x => x * x));


            Assert.AreEqual(6, qInt.Max());
            Assert.AreEqual(36, qInt.Max(x => x * x));
            Assert.AreEqual(6, qInt.Reverse().Max());
            Assert.AreEqual(36, qInt.Reverse().Max(x => x * x));
            Assert.AreEqual(1, qInt.Min());
            Assert.AreEqual(1, qInt.Min(x => x * x));
            Assert.AreEqual(1, qInt.Reverse().Min());
            Assert.AreEqual(1, qInt.Reverse().Min(x => x * x));
            Assert.AreEqual(6, qDouble.Max());
            Assert.AreEqual(36, qDouble.Max(x => x * x));
            Assert.AreEqual(6, qDouble.Reverse().Max());
            Assert.AreEqual(36, qDouble.Reverse().Max(x => x * x));
            Assert.AreEqual(1, qDouble.Min());
            Assert.AreEqual(1, qDouble.Min(x => x * x));
            Assert.AreEqual(1, qDouble.Reverse().Min());
            Assert.AreEqual(1, qDouble.Reverse().Min(x => x * x));
            Assert.AreEqual(6, qLong.Max());
            Assert.AreEqual(36, qLong.Max(x => x * x));
            Assert.AreEqual(6, qLong.Reverse().Max());
            Assert.AreEqual(36, qLong.Reverse().Max(x => x * x));
            Assert.AreEqual(1, qLong.Min());
            Assert.AreEqual(1, qLong.Min(x => x * x));
            Assert.AreEqual(1, qLong.Reverse().Min());
            Assert.AreEqual(1, qLong.Reverse().Min(x => x * x));
            Assert.AreEqual(6, qDecimal.Max());
            Assert.AreEqual(36, qDecimal.Max(x => x * x));
            Assert.AreEqual(6, qDecimal.Reverse().Max());
            Assert.AreEqual(36, qDecimal.Reverse().Max(x => x * x));
            Assert.AreEqual(1, qDecimal.Min());
            Assert.AreEqual(1, qDecimal.Min(x => x * x));
            Assert.AreEqual(1, qDecimal.Reverse().Min());
            Assert.AreEqual(1, qDecimal.Reverse().Min(x => x * x));
            Assert.AreEqual(6, qnInt.Max());
            Assert.AreEqual(36, qnInt.Max(x => x * x));
            Assert.AreEqual(6, qnInt.Reverse().Max());
            Assert.AreEqual(36, qnInt.Reverse().Max(x => x * x));
            Assert.AreEqual(1, qnInt.Min());
            Assert.AreEqual(1, qnInt.Min(x => x * x));
            Assert.AreEqual(1, qnInt.Reverse().Min());
            Assert.AreEqual(1, qnInt.Reverse().Min(x => x * x));
            Assert.AreEqual(6, qnDouble.Max());
            Assert.AreEqual(36, qnDouble.Max(x => x * x));
            Assert.AreEqual(6, qnDouble.Reverse().Max());
            Assert.AreEqual(36, qnDouble.Reverse().Max(x => x * x));
            Assert.AreEqual(1, qnDouble.Min());
            Assert.AreEqual(1, qnDouble.Min(x => x * x));
            Assert.AreEqual(1, qnDouble.Reverse().Min());
            Assert.AreEqual(1, qnDouble.Reverse().Min(x => x * x));
            Assert.AreEqual(6, qnLong.Max());
            Assert.AreEqual(36, qnLong.Max(x => x * x));
            Assert.AreEqual(6, qnLong.Reverse().Max());
            Assert.AreEqual(36, qnLong.Reverse().Max(x => x * x));
            Assert.AreEqual(1, qnLong.Min());
            Assert.AreEqual(1, qnLong.Min(x => x * x));
            Assert.AreEqual(1, qnLong.Reverse().Min());
            Assert.AreEqual(1, qnLong.Reverse().Min(x => x * x));
            Assert.AreEqual(6, qnDecimal.Max());
            Assert.AreEqual(36, qnDecimal.Max(x => x * x));
            Assert.AreEqual(6, qnDecimal.Reverse().Max());
            Assert.AreEqual(36, qnDecimal.Reverse().Max(x => x * x));
            Assert.AreEqual(1, qnDecimal.Min());
            Assert.AreEqual(1, qnDecimal.Min(x => x * x));
            Assert.AreEqual(1, qnDecimal.Reverse().Min());
            Assert.AreEqual(1, qnDecimal.Reverse().Min(x => x * x));
            Assert.AreEqual(6, q.OfType<int>().Count());
            Assert.AreEqual(0, q.OfType<string>().Count());
            Assert.AreEqual(5, q.OrderBy(x => names[x]).First());
            Assert.AreEqual(2, q.OrderByDescending(x => names[x]).First());
            Assert.AreEqual(2, q.OrderBy(x => names[x / 2]).ThenBy(x => x).First());
            Assert.AreEqual(1, q.OrderByDescending(x => names[x / 2]).ThenByDescending(x => x).First());
            Assert.AreEqual(5, q.OrderBy(x => names[x], comp).First());
            Assert.AreEqual(2, q.OrderByDescending(x => names[x], comp).First());
            Assert.AreEqual(2, q.OrderBy(x => names[x / 2], comp).ThenBy(x => x).First());
            Assert.AreEqual(1, q.OrderByDescending(x => names[x / 2], comp).ThenByDescending(x => x).First());
            Assert.AreEqual(6, q.Select(x => x * x).Count());
            Assert.AreEqual(12, q.SelectMany(x => q2).Count());
            Assert.AreEqual(12, q.SelectMany(x => q2, (x, y) => new { x, y }).Count());
            Assert.AreEqual(6, q.Select((x, i) => x * i).Count());
            Assert.AreEqual(12, q.SelectMany((x, i) => q2).Count());
            Assert.AreEqual(9, qs.Single());
            Assert.AreEqual(6, q.Single(x => x > 5));
            Assert.AreEqual(9, qs.SingleOrDefault());
            Assert.AreEqual(0, qe.SingleOrDefault());
            Assert.AreEqual(6, q.SingleOrDefault(x => x > 5));
            Assert.AreEqual(0, q.SingleOrDefault(x => x > 10));
            Assert.AreEqual(4, q.Skip(2).Count());
            Assert.AreEqual(3, q.SkipWhile(x => x < 4).Count());
            Assert.AreEqual(3, q.SkipWhile((x, i) => x < 4).Count());
            Assert.AreEqual(3, q.Take(3).Count());
            Assert.AreEqual(3, q.TakeWhile(x => x < 4).Count());
            Assert.AreEqual(3, q.TakeWhile((x, i) => x < 4).Count());
            Assert.AreEqual(6, q.Union(q).Count());
            Assert.AreEqual(6, s.Union(q).Count());
            Assert.AreEqual(6, q.Union(s).Count());
            Assert.AreEqual(7, q.Union(qs).Count());
            Assert.AreEqual(3, q.Where(x => x > 3).Count());
            Assert.AreEqual(6, q.Where((x, i) => x > i).Count());

            Assert.AreEqual(2, q.Join(q2, v => v, v => v, (x, y) => new { x, y }).Count());
            Assert.AreEqual(2, s.Join(q2, v => v, v => v, (x, y) => new { x, y }).Count());
            Assert.AreEqual(2, q.Join(s2, v => v, v => v, (x, y) => new { x, y }).Count());
            Assert.AreEqual(6, q.GroupJoin(q2, v => v, v => v, (x, ys) => new { x, ys }).Count());
            Assert.AreEqual(6, s.GroupJoin(q2, v => v, v => v, (x, ys) => new { x, ys }).Count());
            Assert.AreEqual(6, q.GroupJoin(s2, v => v, v => v, (x, ys) => new { x, ys }).Count());

            // Aggregates  (count and longcount included above)
            Assert.AreEqual(1, q.Min());
            Assert.AreEqual(1, q.Min(x => x));
            Assert.AreEqual(6, q.Max());
            Assert.AreEqual(6, q.Max(x => x));
            Assert.AreEqual(21, q.Sum());
            Assert.AreEqual(21, q.Select(x => (int?)x).Sum());
            Assert.AreEqual(21, q.Select(x => (long)x).Sum());
            Assert.AreEqual(21, q.Select(x => (long?)x).Sum());
            Assert.AreEqual(21, q.Select(x => (double)x).Sum());
            Assert.AreEqual(21, q.Select(x => (double?)x).Sum());
            Assert.AreEqual(21, q.Select(x => (decimal)x).Sum());
            Assert.AreEqual(21, q.Select(x => (decimal?)x).Sum());
            Assert.AreEqual(21, q.Sum(x => x));
            Assert.AreEqual(21, q.Sum(x => (int?)x));
            Assert.AreEqual(21, q.Sum(x => (long)x));
            Assert.AreEqual(21, q.Sum(x => (long?)x));
            Assert.AreEqual(21, q.Sum(x => (double)x));
            Assert.AreEqual(21, q.Sum(x => (double?)x));
            Assert.AreEqual(21, q.Sum(x => (decimal)x));
            Assert.AreEqual(21, q.Sum(x => (decimal?)x));
            Assert.AreEqual(3.5, q.Average());
            Assert.AreEqual(3.5, q.Select(x => (int?)x).Average());
            Assert.AreEqual(3.5, q.Select(x => (long)x).Average());
            Assert.AreEqual(3.5, q.Select(x => (long?)x).Average());
            Assert.AreEqual(3.5, q.Select(x => (double)x).Average());
            Assert.AreEqual(3.5, q.Select(x => (double?)x).Average());
            Assert.AreEqual(3.5m, q.Select(x => (decimal)x).Average());
            Assert.AreEqual(3.5m, q.Select(x => (decimal?)x).Average());
            Assert.AreEqual(3.5, q.Average(x => x));
            Assert.AreEqual(3.5, q.Average(x => (int?)x));
            Assert.AreEqual(3.5, q.Average(x => (long)x));
            Assert.AreEqual(3.5, q.Average(x => (long?)x));
            Assert.AreEqual(3.5, q.Average(x => (double)x));
            Assert.AreEqual(3.5, q.Average(x => (double?)x));
            Assert.AreEqual(3.5m, q.Average(x => (decimal)x));
            Assert.AreEqual(3.5m, q.Average(x => (decimal?)x));
            ...
            Assert.AreEqual(13, s.Zip(s2, (a, b) => a * b).Sum());
            Assert.AreEqual(13, q.Zip(q2, (a, b) => a * b).Sum());
            Assert.AreEqual(34, s2.Zip(s2, (a, b) => a * b).Sum());
            Assert.AreEqual(34, q2.Zip(q2, (a, b) => a * b).Sum());
        }
        ...
        private static IEnumerable<MethodInfo> GetMissingExtensionMethods(Type a, Type b, string[] excludedMethods)
        {
            ...
            var aMethods =
                ...
                .Where(m => m.HasAttribute<ExtensionAttribute>())
                .ToLookup(m => m.Name);
    ...
    public class Compiler_Tests
    {
        ...
        public static void TestAndAlso()
        {
            ...
            Assert.AreEqual(r2.value, r1.value);
        }
        ...
        public static void AndAlsoLift()
        {
            ...
            Assert.NotNull(f1());
            Assert.AreEqual(f1().Value.Name, "And");
            ...
            Assert.NotNull(f2());
            Assert.AreEqual(f2().Value.Name, "lhs");
        ...
        public class CustomerWriteBack
        {
            ...
            public static int Prop { get { return 7; } set { Assert.AreEqual(5, value); } }
        ...
        public static void UnaryPlus()
        {
            ...
            Assert.AreEqual(testExpr.ToString(), "x => +x");
        ...
        public static void Casts()
        {
            ...
            Assert.AreEqual(10, TestCast<System.ValueType, int>(10));

            // System.ValueType to enum type
            Assert.AreEqual(ExpressionType.Add, TestCast<System.ValueType, ExpressionType>(ExpressionType.Add));

            // System.Enum to enum type
            Assert.AreEqual(ExpressionType.Add, TestCast<System.Enum, ExpressionType>(ExpressionType.Add));
            ...
            // Enum to System.Enum
            Assert.AreEqual(ExpressionType.Add, TestCast<ExpressionType, System.Enum>(ExpressionType.Add));

            // Enum to System.ValueType
            Assert.AreEqual(ExpressionType.Add, TestCast<ExpressionType, System.ValueType>(ExpressionType.Add));
            ...
            Assert.AreEqual(10, TestCast<int?, object>(10));

            // object to nullable (unbox)
            Assert.AreEqual(10, TestCast<object, int?>(10));
        ...
        {
            Assert.AreEqual((byte)10, TestConvert<byte, byte>(10));
            Assert.AreEqual((byte)10, TestConvert<sbyte, byte>(10));
            Assert.AreEqual((byte)10, TestConvert<short, byte>(10));
            Assert.AreEqual((byte)10, TestConvert<ushort, byte>(10));
            Assert.AreEqual((byte)10, TestConvert<int, byte>(10));
            Assert.AreEqual((byte)10, TestConvert<uint, byte>(10));
            Assert.AreEqual((byte)10, TestConvert<long, byte>(10));
            Assert.AreEqual((byte)10, TestConvert<ulong, byte>(10));
            Assert.AreEqual((byte)10, TestConvert<float, byte>(10.0f));
            Assert.AreEqual((byte)10, TestConvert<float, byte>(10.0f));
            Assert.AreEqual((byte)10, TestConvert<double, byte>(10.0));
            Assert.AreEqual((byte)10, TestConvert<double, byte>(10.0));
            Assert.AreEqual((byte)10, TestConvert<decimal, byte>(10m));
            Assert.AreEqual((byte)10, TestConvert<decimal, byte>(10m));

            Assert.AreEqual((short)10, TestConvert<byte, short>(10));
            Assert.AreEqual((short)10, TestConvert<sbyte, short>(10));
            Assert.AreEqual((short)10, TestConvert<short, short>(10));
            Assert.AreEqual((short)10, TestConvert<ushort, short>(10));
            Assert.AreEqual((short)10, TestConvert<int, short>(10));
            Assert.AreEqual((short)10, TestConvert<uint, short>(10));
            Assert.AreEqual((short)10, TestConvert<long, short>(10));
            Assert.AreEqual((short)10, TestConvert<ulong, short>(10));
            Assert.AreEqual((short)10, TestConvert<float, short>(10.0f));
            Assert.AreEqual((short)10, TestConvert<double, short>(10.0));
            Assert.AreEqual((short)10, TestConvert<decimal, short>(10m));

            Assert.AreEqual((int)10, TestConvert<byte, int>(10));
            Assert.AreEqual((int)10, TestConvert<sbyte, int>(10));
            Assert.AreEqual((int)10, TestConvert<short, int>(10));
            Assert.AreEqual((int)10, TestConvert<ushort, int>(10));
            Assert.AreEqual((int)10, TestConvert<int, int>(10));
            Assert.AreEqual((int)10, TestConvert<uint, int>(10));
            Assert.AreEqual((int)10, TestConvert<long, int>(10));
            Assert.AreEqual((int)10, TestConvert<ulong, int>(10));
            Assert.AreEqual((int)10, TestConvert<float, int>(10.0f));
            Assert.AreEqual((int)10, TestConvert<double, int>(10.0));
            Assert.AreEqual((int)10, TestConvert<decimal, int>(10m));

            Assert.AreEqual((long)10, TestConvert<byte, long>(10));
            Assert.AreEqual((long)10, TestConvert<sbyte, long>(10));
            Assert.AreEqual((long)10, TestConvert<short, long>(10));
            Assert.AreEqual((long)10, TestConvert<ushort, long>(10));
            Assert.AreEqual((long)10, TestConvert<int, long>(10));
            Assert.AreEqual((long)10, TestConvert<uint, long>(10));
            Assert.AreEqual((long)10, TestConvert<long, long>(10));
            Assert.AreEqual((long)10, TestConvert<ulong, long>(10));
            Assert.AreEqual((long)10, TestConvert<float, long>(10.0f));
            Assert.AreEqual((long)10, TestConvert<double, long>(10.0));
            Assert.AreEqual((long)10, TestConvert<decimal, long>(10m));

            Assert.AreEqual((double)10, TestConvert<byte, double>(10));
            Assert.AreEqual((double)10, TestConvert<sbyte, double>(10));
            Assert.AreEqual((double)10, TestConvert<short, double>(10));
            Assert.AreEqual((double)10, TestConvert<ushort, double>(10));
            Assert.AreEqual((double)10, TestConvert<int, double>(10));
            Assert.AreEqual((double)10, TestConvert<uint, double>(10));
            Assert.AreEqual((double)10, TestConvert<long, double>(10));
            Assert.AreEqual((double)10, TestConvert<ulong, double>(10));
            Assert.AreEqual((double)10, TestConvert<float, double>(10.0f));
            Assert.AreEqual((double)10, TestConvert<double, double>(10.0));
            Assert.AreEqual((double)10, TestConvert<decimal, double>(10m));

            Assert.AreEqual((decimal)10, TestConvert<byte, decimal>(10));
            Assert.AreEqual((decimal)10, TestConvert<sbyte, decimal>(10));
            Assert.AreEqual((decimal)10, TestConvert<short, decimal>(10));
            Assert.AreEqual((decimal)10, TestConvert<ushort, decimal>(10));
            Assert.AreEqual((decimal)10, TestConvert<int, decimal>(10));
            Assert.AreEqual((decimal)10, TestConvert<uint, decimal>(10));
            Assert.AreEqual((decimal)10, TestConvert<long, decimal>(10));
            Assert.AreEqual((decimal)10, TestConvert<ulong, decimal>(10));
            Assert.AreEqual((decimal)10, TestConvert<float, decimal>(10.0f));
            Assert.AreEqual((decimal)10, TestConvert<double, decimal>(10.0));
            Assert.AreEqual((decimal)10, TestConvert<decimal, decimal>(10m));
        ...
        public static void ConvertMinMax()
        {
            unchecked
            {
                Assert.AreEqual((float)uint.MaxValue, TestConvert<uint, float>(uint.MaxValue));
                Assert.AreEqual((double)uint.MaxValue, TestConvert<uint, double>(uint.MaxValue));
                Assert.AreEqual((float?)uint.MaxValue, TestConvert<uint, float?>(uint.MaxValue));
                Assert.AreEqual((double?)uint.MaxValue, TestConvert<uint, double?>(uint.MaxValue));

                Assert.AreEqual((float)ulong.MaxValue, TestConvert<ulong, float>(ulong.MaxValue));
                Assert.AreEqual((double)ulong.MaxValue, TestConvert<ulong, double>(ulong.MaxValue));
                Assert.AreEqual((float?)ulong.MaxValue, TestConvert<ulong, float?>(ulong.MaxValue));
                Assert.AreEqual((double?)ulong.MaxValue, TestConvert<ulong, double?>(ulong.MaxValue));
                ...
                Assert.AreEqual((float)(uint?)uint.MaxValue, TestConvert<uint?, float>(uint.MaxValue));
                Assert.AreEqual((double)(uint?)uint.MaxValue, TestConvert<uint?, double>(uint.MaxValue));
                Assert.AreEqual((float?)(uint?)uint.MaxValue, TestConvert<uint?, float?>(uint.MaxValue));
                Assert.AreEqual((double?)(uint?)uint.MaxValue, TestConvert<uint?, double?>(uint.MaxValue));

                Assert.AreEqual((float)(ulong?)ulong.MaxValue, TestConvert<ulong?, float>(ulong.MaxValue));
                Assert.AreEqual((double)(ulong?)ulong.MaxValue, TestConvert<ulong?, double>(ulong.MaxValue));
                Assert.AreEqual((float?)(ulong?)ulong.MaxValue, TestConvert<ulong?, float?>(ulong.MaxValue));
                Assert.AreEqual((double?)(ulong?)ulong.MaxValue, TestConvert<ulong?, double?>(ulong.MaxValue));
            }
        }
        ...
        public static void ConvertToChar()
        {
            ...
            Assert.AreEqual(UInt16.MaxValue, f4());
        }
        ...
        public static void LiftedAddDateTimeTimeSpan()
        {
            ...
            Assert.AreEqual(ExpressionType.Add, f.Body.NodeType);
            Console.WriteLine(f);
            Func<DateTime?, TimeSpan, DateTime?> d = f.Compile();
            DateTime? dt = DateTime.Now;
            TimeSpan ts = new TimeSpan(3, 2, 1);
            DateTime? dt2 = dt + ts;
            Assert.AreEqual(dt2, d(dt, ts));
        ...
        public static void LiftedSubDateTime()
        {
            ...
            Assert.AreEqual(ExpressionType.Subtract, f.Body.NodeType);
            Console.WriteLine(f);
            Func<DateTime?, DateTime?, TimeSpan?> d = f.Compile();
            DateTime? dt1 = DateTime.Now;
            DateTime? dt2 = new DateTime(2006, 5, 1);
            TimeSpan? ts = dt1 - dt2;
            Assert.AreEqual(ts, d(dt1, dt2));
        ...
        public static void LiftedEqualDateTime()
        {
            ...
            Assert.AreEqual(ExpressionType.Equal, f.Body.NodeType);
            Console.WriteLine(f);
        ...
        {
            Expression<Func<DateTime?, DateTime?, bool>> f = (x, y) => x != y;
            Assert.AreEqual(ExpressionType.NotEqual, f.Body.NodeType);
            Console.WriteLine(f);
            Func<DateTime?, DateTime?, bool> d = f.Compile();
            DateTime? dt1 = DateTime.Now;
            DateTime? dt2 = new DateTime(2006, 5, 1);
        ...
        {
            Expression<Func<DateTime?, DateTime?, bool>> f = (x, y) => x < y;
            Assert.AreEqual(ExpressionType.LessThan, f.Body.NodeType);
            Console.WriteLine(f);
            Func<DateTime?, DateTime?, bool> d = f.Compile();
            DateTime? dt1 = DateTime.Now;
            DateTime? dt2 = new DateTime(2006, 5, 1);
        ...
        public static void CallCompiledLambdaWithTypeMissing()
        {
            ...
            Assert.AreEqual(true, d(Type.Missing));
        }
        ...
        public static void InvokeComputedLambda()
        {
            ...
            Assert.AreEqual(14, d(5, 9));
            Assert.AreEqual(40, d(5, 8));
        }
        ...
        public static void CoalesceRefTypes()
        {
            ...
            var d = f.Compile();
            Assert.AreEqual("nil", d(null));
            Assert.AreEqual("Not Nil", d("Not Nil"));
        }
        ...
        public static void Conditional()
        {
            ...
            var d = f.Compile();
            Assert.AreEqual(7, d(7, 4));
            Assert.AreEqual(6, d(3, 6));
        }
        ...
        public static void ListInitializerLong()
        {
            ...
            Assert.AreEqual(5, list[0].B);
            Assert.AreEqual(6, list[1].B);
            Assert.AreEqual(7, list[2].B);
        }
        ...
        public void NewClassWithMemberListIntializer()
        {
            ...
            var d = f.Compile();
            ClassX x = d(5);
            Assert.AreEqual(5, x.A);
            Assert.AreEqual(6, x.B);
            Assert.AreEqual(1, x.Ys.Count);
            Assert.AreEqual(7, x.Ys[0].B);
        }
        ...
        public void NewClassWithMemberListOfStructIntializer()
        {
            ...
            Assert.AreEqual(5, x.A);
            Assert.AreEqual(6, x.B);
            Assert.AreEqual(1, x.SYs.Count);
            Assert.AreEqual(7, x.SYs[0].B);
        }
        ...
        public static void UnaryOperators()
        {
            ...
            Assert.AreEqual(~1, TestUnary<int, int>(ExpressionType.Not, 1));
            Assert.AreEqual(~1, TestUnary<int?, int?>(ExpressionType.Not, 1));
            Assert.Null(TestUnary<int?, int?>(ExpressionType.Not, null));

            // Negate
            Assert.AreEqual(-1, TestUnary<int, int>(ExpressionType.Negate, 1));
            Assert.AreEqual(-1, TestUnary<int?, int?>(ExpressionType.Negate, 1));
            Assert.Null(TestUnary<int?, int?>(ExpressionType.Negate, null));
            Assert.AreEqual(-1, TestUnary<int, int>(ExpressionType.NegateChecked, 1));
            Assert.AreEqual(-1, TestUnary<int?, int?>(ExpressionType.NegateChecked, 1));
            Assert.Null(TestUnary<int?, int?>(ExpressionType.NegateChecked, null));

            Assert.AreEqual(-1, TestUnary<decimal, decimal>(ExpressionType.Negate, 1));
            Assert.AreEqual(-1, TestUnary<decimal?, decimal?>(ExpressionType.Negate, 1));
            Assert.Null(TestUnary<decimal?, decimal?>(ExpressionType.Negate, null));
            Assert.AreEqual(-1, TestUnary<decimal, decimal>(ExpressionType.NegateChecked, 1));
            Assert.AreEqual(-1, TestUnary<decimal?, decimal?>(ExpressionType.NegateChecked, 1));
        ...
        public static void ConvertSignedToUnsigned()
        {
            ...
            Assert.AreEqual(UInt64.MaxValue, f());
        }
        ...
        public static void IntSwitch1()
        {
            ...
            Assert.AreEqual("hello", f(1));
            Assert.AreEqual("two", f(2));
            Assert.AreEqual("default", f(3));
        }
        ...
        public static void NullableIntSwitch1()
        {
            ...
            Assert.AreEqual("hello", f(1));
            Assert.AreEqual("two", f(2));
            Assert.AreEqual("default", f(null));
            Assert.AreEqual("default", f(3));
        }
        ...
        public static void IntSwitch3()
        {
            ...
            Assert.AreEqual("hello", f(1));
            Assert.AreEqual("wow", f(uint.MaxValue));
            Assert.AreEqual("two", f(2));
            Assert.AreEqual("default", f(3));
        }
        ...
        public static void StringSwitch()
        {
            ...
            Assert.AreEqual("hello", f("hi"));
            Assert.AreEqual("lala", f("bye"));
            Assert.AreEqual("default", f("hi2"));
            Assert.AreEqual("default", f(null));
        }
        ...
        public static void BinaryOperators()
        {
            ...
            Assert.AreEqual(2, TestBinary<int, int>(ExpressionType.And, 2, 3));
            Assert.AreEqual(2, TestBinary<int?, int?>(ExpressionType.And, 2, 3));
            ...
            Assert.AreEqual(3, TestBinary<int, int>(ExpressionType.Or, 2, 1));
            Assert.AreEqual(3, TestBinary<int?, int?>(ExpressionType.Or, 2, 1));
            ...
            Assert.AreEqual(4, TestBinary<int, int>(ExpressionType.ExclusiveOr, 5, 1));
            Assert.AreEqual(4, TestBinary<int?, int?>(ExpressionType.ExclusiveOr, 5, 1));
            ...
            // Add
            Assert.AreEqual(3, TestBinary<int, int>(ExpressionType.Add, 1, 2));
            Assert.AreEqual(3, TestBinary<int?, int?>(ExpressionType.Add, 1, 2));
            ...
            Assert.AreEqual(3, TestBinary<decimal, decimal>(ExpressionType.Add, 1, 2));
            Assert.AreEqual(3, TestBinary<decimal?, decimal?>(ExpressionType.Add, 1, 2));
            ...
            // AddChecked
            Assert.AreEqual(3, TestBinary<int, int>(ExpressionType.AddChecked, 1, 2));
            Assert.AreEqual(3, TestBinary<int?, int?>(ExpressionType.AddChecked, 1, 2));
            ...
            // Subtract
            Assert.AreEqual(1, TestBinary<int, int>(ExpressionType.Subtract, 2, 1));
            Assert.AreEqual(1, TestBinary<int?, int?>(ExpressionType.Subtract, 2, 1));
            ...
            Assert.AreEqual(1, TestBinary<decimal, decimal>(ExpressionType.Subtract, 2, 1));
            Assert.AreEqual(1, TestBinary<decimal?, decimal?>(ExpressionType.Subtract, 2, 1));
            ...
            // SubtractChecked
            Assert.AreEqual(1, TestBinary<int, int>(ExpressionType.SubtractChecked, 2, 1));
            Assert.AreEqual(1, TestBinary<int?, int?>(ExpressionType.SubtractChecked, 2, 1));
            ...
            // Multiply
            Assert.AreEqual(2, TestBinary<int, int>(ExpressionType.Multiply, 2, 1));
            Assert.AreEqual(2, TestBinary<int?, int?>(ExpressionType.Multiply, 2, 1));
            ...
            Assert.AreEqual(2, TestBinary<decimal, decimal>(ExpressionType.Multiply, 2, 1));
            Assert.AreEqual(2, TestBinary<decimal?, decimal?>(ExpressionType.Multiply, 2, 1));
            ...
            // MultiplyChecked
            Assert.AreEqual(2, TestBinary<int, int>(ExpressionType.MultiplyChecked, 2, 1));
            Assert.AreEqual(2, TestBinary<int?, int?>(ExpressionType.MultiplyChecked, 2, 1));
            ...
            // Divide
            Assert.AreEqual(2, TestBinary<int, int>(ExpressionType.Divide, 5, 2));
            Assert.AreEqual(2, TestBinary<int?, int?>(ExpressionType.Divide, 5, 2));
            ...
            Assert.AreEqual(2.5m, TestBinary<decimal, decimal>(ExpressionType.Divide, 5, 2));
            Assert.AreEqual(2.5m, TestBinary<decimal?, decimal?>(ExpressionType.Divide, 5, 2));
            ...
            // Modulo 
            Assert.AreEqual(3, TestBinary<int, int>(ExpressionType.Modulo, 7, 4));
            Assert.AreEqual(3, TestBinary<int?, int?>(ExpressionType.Modulo, 7, 4));
            ...
            Assert.AreEqual(3, TestBinary<decimal, decimal>(ExpressionType.Modulo, 7, 4));
            Assert.AreEqual(3, TestBinary<decimal?, decimal?>(ExpressionType.Modulo, 7, 4));
            ...
            // Power
            Assert.AreEqual(16, TestBinary<double, double>(ExpressionType.Power, 2, 4));
            Assert.AreEqual(16, TestBinary<double?, double?>(ExpressionType.Power, 2, 4));
            ...
            // LeftShift
            Assert.AreEqual(10, TestBinary<int, int>(ExpressionType.LeftShift, 5, 1));
            Assert.AreEqual(10, TestBinary<int?, int?>(ExpressionType.LeftShift, 5, 1));
            ...
            // RightShift
            Assert.AreEqual(2, TestBinary<int, int>(ExpressionType.RightShift, 4, 1));
            Assert.AreEqual(2, TestBinary<int?, int?>(ExpressionType.RightShift, 4, 1));
        ...
        public static void TestConvertToNullable()
        {
            ...
            Assert.AreEqual(f.Body.NodeType, ExpressionType.Convert);
            Func<int, int?> d = f.Compile();
            Assert.AreEqual(2, d(2));
        }
        ...
        public static void PropertyAccess()
        {
            ...
            Assert.AreEqual(cust, Expression.Lambda(c, c).Compile().DynamicInvoke(cust));
            Assert.AreEqual(cust.ContactName, Expression.Lambda(Expression.PropertyOrField(c, "ContactName"), c).Compile().DynamicInvoke(cust));
            Assert.AreEqual(cust.Orders, Expression.Lambda(Expression.PropertyOrField(c, "Orders"), c).Compile().DynamicInvoke(cust));
            Assert.AreEqual(cust.CustomerID, Expression.Lambda(Expression.PropertyOrField(c, "CustomerId"), c).Compile().DynamicInvoke(cust));
